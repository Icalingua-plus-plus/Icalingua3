...
export class Migration20220918144556 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `message` (`id` text not null, `room_id` text not null, `seq` integer not null, `time` integer not null, `rand` integer not null, `atall` integer not null default false, `atme` integer not null default false, `confirmed` integer not null default true, `content` blob not null, primary key (`id`));');
